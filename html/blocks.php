	...
	<div class="page-wrapper with-navbar with-navbar-fixed-bottom" id="particles-js">
					...
					<div class="col-lg-12">
                        <div class="content">
							...
							<table class="table table-no-outer-padding">
							  ...
							  <tbody>
							<?php foreach ($blocks as $document): ?>
								<tr>
								  <td><a  target="_blank" href="https://explorer.eleneum.org/block/<?php echo $document->height; ?>"><?php echo $document->height; ?></a>
							<?php if($document->solo == 1): ?>
									<br><code>SOLO</code>
							<?php endif; ?>
								  </td>
								  <td><?php echo $document->hash; ?></td>
								  <td><?php echo $document->difficulty; ?></td>
								  <td><?php echo convertTime(intval(time()-$document->ts)); ?></td>
							<?php if($document->reward == -1): ?>
								  <td>0 ELENA (Orphan block)</td>
							<?php else: ?>
								  <td><?php echo $document->reward/1000000000000000000; ?> ELENA</td>
							<?php endif; ?>
								</tr>
							<?php endforeach; ?>
							  </tbody>
        ...
        <nav class="navbar navbar-fixed-bottom">
            ...
            <!--<span class="navbar-text">
                Made with <i style="margin:0px 8px 0px 8px;" class="fa fa-heart" aria-hidden="true"></i> by Eleneum
            </span>-->
        </nav>
