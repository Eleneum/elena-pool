...
<head>
    ...
    <link href="/static/site/css/landing-styles-3.css" rel="stylesheet">
	  <!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-5FX86S2ZHC"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'G-5FX86S2ZHC');
</script>
</head>
                        ...
                        <div class="content">
							...
							<table class="table table-no-outer-padding">
							  ...
							  <div class="col-lg-1"></div>
								<div class="col-lg-5">
							<!-- No outer padding -->
							<b>Mining Command Sample</b>
							<code class="code">-o <?php echo $data['url']; ?>:<?php echo $data['port']; ?> -u YOUR_WALLET -a randomx</code>
							<br>
							<br>
							<b>Worker ID (-u YOUR_WALLET.WORKERID)</b>
							<code class="code">-o <?php echo $data['url']; ?>:<?php echo $data['port']; ?> -u YOUR_WALLET.WORKERID -a randomx</code>
							<br>
							<br>
							<b>Worker ID + Fixed Diff (-u YOUR_WALLET.WORKERID:DIFFICULTY)</b>
							<code class="code">-o <?php echo $data['url']; ?>:<?php echo $data['port']; ?> -u YOUR_WALLET.WORKERID:DIFFICULTY -a randomx</code>
							<br>
							<br>
							<b>Fixed Diff (-u YOUR_WALLET:DIFFICULTY)</b>
							<code class="code">-o <?php echo $data['url']; ?>:<?php echo $data['port']; ?> -u YOUR_WALLET:DIFFICULTY -a randomx</code>
							<br>
							<br>
							<b>SOLO Mining (-p solo)</b>
							<code class="code">-o <?php echo $data['url']; ?>:<?php echo $data['port']; ?> -u YOUR_WALLET -a randomx -p solo</code>
							  </div>
							</div>
							  <div class="row">
							<!-- No outer padding -->
							...
							<table class="table table-no-outer-padding">
							  ...
							  <tbody>
								<tr>
								  ...
								  <td><a href="https://github.com/fireice-uk/xmr-stak/releases/latest">Download</a></td>
								</tr>
								<tr>
								  <th>XMRig</th>
								  <td>CPU & GPU (AMD/NVIDIA)</td>
								  <td><a href="https://github.com/xmrig/xmrig/releases/latest">Download</a></td>
								</tr>
							  </tbody>
							</table>
							  </div>
